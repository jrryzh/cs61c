...
int allocate_matrix(matrix **mat, int rows, int cols) {
    ...
    *mat = (matrix *)calloc(1, sizeof(matrix));
    p_data = (double *)calloc(rows * cols, sizeof(double));
    if (mat == NULL)
    {
        return -2;
    }
...
int identity_matrix(matrix *result) {
